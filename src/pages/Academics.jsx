  ...
  return (
    <div className="py-8 md:py-12">
      <div className="container mx-auto px-4">
        <h1 className="text-3xl md:text-4xl font-bold mb-6 md:mb-8 text-gray-800">Academics</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-8 md:mb-12">
          <div className="bg-white border-l-4 border-blue-600 p-4 md:p-6 shadow-md hover:shadow-lg transition">
            <h3 className="text-lg md:text-xl font-bold mb-3 text-gray-800">Kindergarten and Nursery School (K-5)</h3>
            <p className="text-sm md:text-base text-gray-600 mb-4">
